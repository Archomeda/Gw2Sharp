...
namespace Gw2Sharp.WebApi.V2.Clients
{
    ...
    public class AccountHomeClient : BaseClient, IAccountHomeClient
    {
        ...
        internal AccountHomeClient(IConnection connection, IGw2Client gw2Client) :
            base(connection, gw2Client)
        {
            this.cats = new AccountHomeCatsClient(connection, gw2Client);
            this.nodes = new AccountHomeNodesClient(connection, gw2Client);
        }
