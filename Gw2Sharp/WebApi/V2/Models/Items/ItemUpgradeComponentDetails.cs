...
namespace Gw2Sharp.WebApi.V2.Models
{
    ...
    public class ItemUpgradeComponentDetails
    {
        ...
        /// </summary>
        public ApiEnum<ItemUpgradeComponentType> Type { get; set; }

        /// <summary>
        /// The item upgrade component flags.
        /// </summary>
        public ApiFlags<ItemUpgradeComponentFlag> Flags { get; set; }

        /// <summary>
        /// The item infusion flags.
        /// </summary>
        public ApiFlags<ItemInfusionFlag> InfusionUpgradeFlags { get; set; }
