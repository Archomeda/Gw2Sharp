...
namespace Gw2Sharp.WebApi.Caching
{
    ...
    public interface ICacheMethod : IDisposable
    {
        ...
        Task<CacheItem<T>?> TryGetAsync<T>(string category, string id);
        ...
        /// <returns>The task for this operation.</returns>
        Task SetAsync<T>(string category, string id, T item, DateTimeOffset expiryTime);
        ...
        /// </returns>
        Task<IDictionary<string, CacheItem<T>>> GetManyAsync<T>(string category, IEnumerable<string> ids);
        ...
        Task<CacheItem<T>> GetOrUpdateAsync<T>(string category, string id, DateTimeOffset expiryTime, Func<Task<T>> updateFunc);
        ...
        /// <param name="updateFunc">The method that is called when no cache has been found.</param>
        /// <returns>The item.</returns>
        Task<CacheItem<T>> GetOrUpdateAsync<T>(string category, string id, Func<Task<(T, DateTimeOffset)>> updateFunc);
