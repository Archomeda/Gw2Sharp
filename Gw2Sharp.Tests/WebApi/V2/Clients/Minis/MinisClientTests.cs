...
{
    public class MinisClientTests : BaseEndpointClientTests
    {
        public MinisClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Minis;
            this.Client = this.client;
        }

        private readonly IMinisClient client;
