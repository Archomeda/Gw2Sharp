...
{
    public class RecipesSearchInputClientTests : BaseEndpointClientTests<IRecipesSearchInputClient>
    {
        protected override IRecipesSearchInputClient CreateClient(IGw2Client gw2Client) =>
            gw2Client.WebApi.V2.Recipes.Search.Input(1234);
