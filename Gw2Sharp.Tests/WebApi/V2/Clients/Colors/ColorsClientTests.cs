...
{
    public class ColorsClientTests : BaseEndpointClientTests
    {
        public ColorsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Colors;
            this.Client = this.client;
        }

        private readonly IColorsClient client;
