...
{
    public class AccountDailyCraftingClientTests : BaseEndpointClientTests
    {
        public AccountDailyCraftingClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.DailyCrafting;
            this.Client = this.client;
        }

        private readonly IAccountDailyCraftingClient client;
