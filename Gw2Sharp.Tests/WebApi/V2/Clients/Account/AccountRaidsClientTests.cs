...
{
    public class AccountRaidsClientTests : BaseEndpointClientTests
    {
        public AccountRaidsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.Raids;
            this.Client = this.client;
        }

        private readonly IAccountRaidsClient client;
