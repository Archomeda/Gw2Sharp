...
{
    public class AccountFinishersClientTests : BaseEndpointClientTests
    {
        public AccountFinishersClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.Finishers;
            this.Client = this.client;
        }

        private readonly IAccountFinishersClient client;
