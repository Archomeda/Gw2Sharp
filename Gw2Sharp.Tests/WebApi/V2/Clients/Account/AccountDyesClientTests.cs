...
{
    public class AccountDyesClientTests : BaseEndpointClientTests
    {
        public AccountDyesClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.Dyes;
            this.Client = this.client;
        }

        private readonly IAccountDyesClient client;
