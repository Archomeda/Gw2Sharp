...
{
    public class AccountSkinsClientTests : BaseEndpointClientTests
    {
        public AccountSkinsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.Skins;
            this.Client = this.client;
        }

        private readonly IAccountSkinsClient client;
