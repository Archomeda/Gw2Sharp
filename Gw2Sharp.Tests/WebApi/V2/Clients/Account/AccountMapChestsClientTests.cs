...
{
    public class AccountMapChestsClientTests : BaseEndpointClientTests
    {
        public AccountMapChestsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.MapChests;
            this.Client = this.client;
        }

        private readonly IAccountMapChestsClient client;
