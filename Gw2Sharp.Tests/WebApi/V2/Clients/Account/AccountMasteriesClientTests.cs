...
{
    public class AccountMasteriesClientTests : BaseEndpointClientTests
    {
        public AccountMasteriesClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.Masteries;
            this.Client = this.client;
        }

        private readonly IAccountMasteriesClient client;
