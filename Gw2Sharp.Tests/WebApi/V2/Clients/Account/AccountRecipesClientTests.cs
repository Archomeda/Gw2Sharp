...
{
    public class AccountRecipesClientTests : BaseEndpointClientTests
    {
        public AccountRecipesClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.Recipes;
            this.Client = this.client;
        }

        private readonly IAccountRecipesClient client;
