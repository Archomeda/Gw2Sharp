...
{
    public class AccountTitlesClientTests : BaseEndpointClientTests
    {
        public AccountTitlesClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.Titles;
            this.Client = this.client;
        }

        private readonly IAccountTitlesClient client;
