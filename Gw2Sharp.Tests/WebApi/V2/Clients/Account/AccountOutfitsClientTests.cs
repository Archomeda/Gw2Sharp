...
{
    public class AccountOutfitsClientTests : BaseEndpointClientTests
    {
        public AccountOutfitsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Account.Outfits;
            this.Client = this.client;
        }

        private readonly IAccountOutfitsClient client;
