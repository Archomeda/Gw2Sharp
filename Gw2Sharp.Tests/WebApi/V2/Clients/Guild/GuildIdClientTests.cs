...
{
    public class GuildIdClientTests : BaseGuildSubEndpointClientTests
    {
        public GuildIdClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Guild["11111111-2222-3333-4444-555555555555"];
            this.Client = this.client;
        }

        private readonly IGuildIdClient client;
