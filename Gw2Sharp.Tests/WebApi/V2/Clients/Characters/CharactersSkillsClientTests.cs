...
{
    public class CharactersSkillsClientTests : BaseCharactersSubEndpointClientTests
    {
        public CharactersSkillsClientTests()
        {
        ...
        private readonly ICharactersSkillsClient client;

        [Theory]
        [InlineData("TestFiles.Characters.CharactersSkills.json")]
