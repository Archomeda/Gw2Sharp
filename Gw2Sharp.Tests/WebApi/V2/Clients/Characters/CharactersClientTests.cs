...
namespace Gw2Sharp.Tests.WebApi.V2.Clients
{
    public class CharactersClientTests : BaseEndpointClientTests
    {
        ...
        public Task GetTestAsync(string file) => this.AssertGetData(this.client, file, "name");

        [Theory]
        [InlineData("TestFiles.Characters.Characters.bulk.json")]
        public Task BulkTestAsync(string file) => this.AssertBulkData(this.client, file, "name");
