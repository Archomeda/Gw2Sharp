...
{
    public class CharactersEquipmentClientTests : BaseCharactersSubEndpointClientTests
    {
        public CharactersEquipmentClientTests()
        {
        ...
        private readonly ICharactersEquipmentClient client;

        [Theory]
        [InlineData("TestFiles.Characters.CharactersEquipment.json")]
