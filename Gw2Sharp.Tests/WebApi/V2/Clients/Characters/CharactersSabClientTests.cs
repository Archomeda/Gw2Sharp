...
{
    public class CharactersSabClientTests : BaseCharactersSubEndpointClientTests
    {
        public CharactersSabClientTests()
        {
        ...
        private readonly ICharactersSabClient client;

        [Theory]
        [InlineData("TestFiles.Characters.CharactersSab.json")]
