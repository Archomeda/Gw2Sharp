...
{
    public class CharactersIdTrainingClientTests : BaseCharactersSubEndpointClientTests
    {
        public CharactersIdTrainingClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Characters["Bob"].Training;
            this.Client = this.client;
        }

        private readonly ICharactersIdTrainingClient client;
