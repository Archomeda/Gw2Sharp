...
{
    public class CharactersCraftingClientTests : BaseCharactersSubEndpointClientTests
    {
        public CharactersCraftingClientTests()
        {
        ...
        private readonly ICharactersCraftingClient client;

        [Theory]
        [InlineData("TestFiles.Characters.CharactersCrafting.json")]
