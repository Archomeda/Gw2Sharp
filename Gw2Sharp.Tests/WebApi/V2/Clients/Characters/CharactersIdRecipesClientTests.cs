...
{
    public class CharactersIdRecipesClientTests : BaseCharactersSubEndpointClientTests
    {
        public CharactersIdRecipesClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Characters["Bob"].Recipes;
            this.Client = this.client;
        }

        private readonly ICharactersIdRecipesClient client;
